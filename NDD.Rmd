...
This is a basic analysis, but it is **standing on the shoulders of giants**, as you can see from the references. Most of this work, indeed, is based on literature search, past experience with public dataset mining, manual selection and curation of the most relevant studies dealing with the genetics of neurodevelopmental disorders. It is by definition not exhaustive and it needs constant curation to be kept updated: so I ask you to contact me for constructive comments and suggestions to improve it..
...
You can take whatever lists of genes of your interest and intersect with all the relevant NDD genes I assembled:
...
As an example I take here the genes defining the cell populations of cortical brain organoids, that we differentiated in the lab and characterised with single cell analysis https://www.biorxiv.org/content/10.1101/484741v2

***

You can hover with the mouse on the intersection of your interest to check the overlapping genes, the enrichement and the significance of the overlap, relative to your gene universe (usually all the genes that you use in your analysis after the initial filtering for not expressed genes) 
...
- the multintersect and sehm function were written by Pierre-Luc Germain (pl.germain@gmail.com)
