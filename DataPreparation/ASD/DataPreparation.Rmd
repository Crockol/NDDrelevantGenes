...
```{r}
ASD <- list(SFARI=SFARIgenes, AutismKB=AutismKBgenes, DDD=DDDneurogenes, MSSNG=MSSNGgenes, ASDsevere=ASDsevereGenes, ID=IDGenes, OMIM= NeuroOmimGenes)
save(ASD, SFARI, AutismKB, DDDneuro, MSSNG, ASDsevere, ID, NeuroOmim, GDI, file = "../../Data/ASD.RData")
```
