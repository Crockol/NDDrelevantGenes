...
```{r}
ASD <- list(SFARI=SFARIgenesAll, AutismKB=AutismKBgenes, DDD=DDDneurogenes, MSSNG=MSSNGgenes, ASDsevere=ASDsevereGenes, ID=IDGenes, OMIM= NeuroOmimGenes, SingleCellASD=SingleCellASDgenes, NeuronASD=NeuronASDgenes, AstrocyteASD=AstrocyteASDgenes, iPSYCH=iPSYCHgenes)
save(ASD, SFARI, SFARIgenes, AutismKB, DDDneuro, MSSNG, ASDsevere, ID, NeuroOmim, iPSYCH, GDI, file = "../../Data/ASD.RData")
```
